...
Preview.prototype.fetchData = function (conf) {
    var me = this;
    me.conf = conf;
    if (!me.conf) {
        return;
...
Preview.prototype.start = function (config, cb) {
    let me = this;
    me.conf = Object.assign({}, config);
    me.conf.customItems = me.conf.mipCustomItems;
    me.conf.url = me.conf.mipCustomData && me.conf.mipCustomData[me.conf.pathName];
    me.conf.cb = cb;
